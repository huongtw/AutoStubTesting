 ...
 *G
 */
public class CheckBoxTreeTableRowForProbePoint<T> extends TreeTableRow<T> {
    ...
    public CheckBoxTreeTableRowForProbePoint() {
        this(item -> {
    ...
    public CheckBoxTreeTableRowForProbePoint(final Callback<TreeItem<T>, ObservableValue<Boolean>> getSelectedProperty) {
    ...
    protected void updateItem(T item, boolean empty) {
        ...
        if (empty) {
            ...
            // if value is TestNewNode then display checkbox
            if (item != null) {
                setGraphic(checkBox);
            } else {
    ...
    public static class CheckBoxTreeTableRowSkin<S> extends TreeTableRowSkin<S> {
        ...
        protected ObjectProperty<Node> graphicProperty() {
            ...
            CheckBoxTreeTableRowForProbePoint<S> treeTableRow = getTableRow();
        ...
        protected CheckBoxTreeTableRowForProbePoint<S> getTableRow() {
            return (CheckBoxTreeTableRowForProbePoint<S>) super.getSkinnable();
        }
    }
    ...
    private static final Logger LOG = Logger
            .getLogger(CheckBoxTreeTableRowForProbePoint.class.getName());
}
