...
public class CheckBoxTreeTableRow<T> extends TreeTableRow<T> {
    ...
    public CheckBoxTreeTableRow(final Callback<TreeItem<T>, ObservableValue<Boolean>> getSelectedProperty) {
...
//                if ((item instanceof TestNewNode && ((TestNewNode) item).getParent() instanceof TestNormalSubprogramNode)
//                        || item instanceof TestNormalSubprogramNode
//                        || item instanceof TestUnitNode)
                    setGraphic(checkBox);
//                else
