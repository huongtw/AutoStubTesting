...
/**
 * Select a random branch (visited or unvisited)
 * 
 * @author Duc Anh Nguyen
 *
 */
public class RandomBranchesSelection extends AbstractPathSelectionStrategy {
	final static AkaLogger logger = AkaLogger.get(RandomBranchesSelection.class);
