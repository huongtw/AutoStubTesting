...
/**
 * Day la code lien quan den keo tha. Dung de tham khao chu khong lien quan den project
 */
...
//        blueCircle.toFront();
//        greenCircle.toFront();
        FXMLLoader loader = new FXMLLoader(Object.class.getResource("/FXML/testCTE/CTEWindow.fxml"));
        try {
